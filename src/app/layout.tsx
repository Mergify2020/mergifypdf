...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "/favicon26.svg", // ✅ references your SVG favicon
  },
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" type="image/svg+xml" href="/favicon26.svg" />
        <link rel="alternate icon" type="image/png" href="/favicon26.svg" />
      </head>
