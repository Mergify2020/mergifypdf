              ...
              {session?.user ? (
                ...
                <div className="flex items-center gap-3">
                  <Link
                    ...
                    className="inline-flex items-center rounded-full border border-white/40 bg-[#6A4EE8]/85 px-7 py-2 text-xs font-semibold text-white shadow-md backdrop-blur-md transition-all hover:-translate-y-0.5 hover:bg-[#5A3FD8]/95 hover:shadow-lg"
                  >
                    Pricing
                  </Link>
                  <HeaderLoginButton />
