      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-8 lg:py-12">
        <div className="relative w-full overflow-hidden rounded-3xl shadow-xl">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, rgba(7, 21, 36, 0.85) 0%, rgba(7, 21, 36, 0.85) 25%, rgba(7, 21, 36, 0) 65%, rgba(7, 21, 36, 0) 100%)",
            }}
            aria-hidden="true"
          />
          ...
          <div className="pointer-events-none absolute inset-0 flex items-start justify-start pt-4 pl-4 sm:pt-6 sm:pl-8">
            <div className="pointer-events-auto flex max-w-md px-8 py-10 text-white sm:max-w-lg sm:px-10 sm:py-12">
              <div>
                <p
                  className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-200 sm:text-xs"
                  style={{ textShadow: "0 10px 35px rgba(0, 0, 0, 0.85)" }}
                >
                  Built for every workflow
                </p>
                <h2
                  className="mt-2 text-2xl font-semibold leading-snug sm:mt-3 sm:text-3xl"
                  style={{ textShadow: "0 10px 35px rgba(0, 0, 0, 0.85)" }}
                >
