...
function ThreadsIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      ...
      <path
        d="M12 7.2c2.4 0 4 1.4 4.3 3.8-.6-.4-1.3-.7-2-.8-.2-.9-.9-1.5-2.2-1.5-1.7 0-2.5.9-2.5 2 0 1 .7 1.7 2 1.9l1.1.2c.7.1 1 .4 1 .9 0 .7-.6 1.2-1.6 1.2-1.1 0-1.8-.5-2.1-1.4-.6.1-1.2.3-1.7.5.4 1.6 1.8 2.7 3.8 2.7 2.3 0 3.7-1.3 3.7-3.2 0-1.8-1.1-2.7-2.9-3l-1-.2c-.7-.1-1-.4-1-.9 0-.6.5-1 1.2-1Z"
        fill="#F9FAFB"
      />
    </svg>
  );
